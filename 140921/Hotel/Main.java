/*Задание: улучшить программу работы  с отелем. Сделать возможность вводить команду поиска комнаты по параметрам следующим образом
getFreeRooms wc wifi sleepingPlace:4
вместо
getFreeRooms wc:true wifi:true sleepingPlace:4

Эту задачу уложить в репозитории в папку Hotel*/
